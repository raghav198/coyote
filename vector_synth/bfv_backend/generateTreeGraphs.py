...
plt.bar(1, norm_tree50_50_3_vec_enc, color = 'blue', yerr = (int1[1] - int1[0]) / (2 * (tree50_50_3_scal_enc_avg + tree50_50_3_scal_run_avg)), ecolor = 'black')
plt.bar(1, norm_tree50_50_3_vec_run, color = 'green', yerr = (int3[1] - int3[0]) / (2 * (tree50_50_3_scal_enc_avg + tree50_50_3_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree50_50_3_vec_enc)
...
plt.bar(2, norm_tree50_50_3_scal_enc, color = 'red', yerr = (int2[1] - int2[0]) / (2 * (tree50_50_3_scal_enc_avg + tree50_50_3_scal_run_avg)), ecolor = 'black')
plt.bar(2, norm_tree50_50_3_scal_run, color = 'yellow', yerr = (int4[1] - int4[0]) / (2 * (tree50_50_3_scal_enc_avg + tree50_50_3_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree50_50_3_scal_enc)
...
plt.bar(4, norm_tree50_50_6_vec_enc, color = 'blue', yerr = (int5[1] - int5[0]) / (2 * (tree50_50_6_scal_enc_avg + tree50_50_6_scal_run_avg)), ecolor = 'black')
plt.bar(4, norm_tree50_50_6_vec_run, color = 'green', yerr = (int7[1] - int7[0]) / (2 * (tree50_50_6_scal_enc_avg + tree50_50_6_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree50_50_6_vec_enc)
...
plt.bar(5, norm_tree50_50_6_scal_enc, color = 'red', yerr = (int6[1] - int6[0]) / (2 * (tree50_50_6_scal_enc_avg + tree50_50_6_scal_run_avg)), ecolor = 'black')
plt.bar(5, norm_tree50_50_6_scal_run, color = 'yellow', yerr = (int8[1] - int8[0]) / (2 * (tree50_50_6_scal_enc_avg + tree50_50_6_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree50_50_6_scal_enc)
...
plt.bar(7, norm_tree100_50_3_vec_enc, color = 'blue', yerr = (int9[1] - int9[0]) / (2 * (tree100_50_3_scal_enc_avg + tree100_50_3_scal_run_avg)), ecolor = 'black')
plt.bar(7, norm_tree100_50_3_vec_run, color = 'green', yerr = (int11[1] - int11[0]) / (2 * (tree100_50_3_scal_enc_avg + tree100_50_3_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree100_50_3_vec_enc)
...
plt.bar(8, norm_tree100_50_3_scal_enc, color = 'red', yerr = (int10[1] - int10[0]) / (2 * (tree100_50_3_scal_enc_avg + tree100_50_3_scal_run_avg)), ecolor = 'black')
plt.bar(8, norm_tree100_50_3_scal_run, color = 'yellow', yerr = (int12[1] - int12[0]) / (2 * (tree100_50_3_scal_enc_avg + tree100_50_3_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree100_50_3_scal_enc)
...
plt.bar(10, norm_tree100_50_6_vec_enc, color = 'blue', yerr = (int13[1] - int13[0]) / (2 * (tree100_50_6_scal_enc_avg + tree100_50_6_scal_run_avg)), ecolor = 'black')
plt.bar(10, norm_tree100_50_6_vec_run, color = 'green', yerr = (int15[1] - int15[0]) / (2 * (tree100_50_6_scal_enc_avg + tree100_50_6_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree100_50_6_vec_enc)
...
plt.bar(11, norm_tree100_50_6_scal_enc, color = 'red', yerr = (int14[1] - int14[0]) / (2 * (tree100_50_6_scal_enc_avg + tree100_50_6_scal_run_avg)), ecolor = 'black')
plt.bar(11, norm_tree100_50_6_scal_run, color = 'yellow', yerr = (int16[1] - int16[0]) / (2 * (tree100_50_6_scal_enc_avg + tree100_50_6_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree100_50_6_scal_enc)
...
plt.bar(13, norm_tree100_100_3_vec_enc, color = 'blue', yerr = (int17[1] - int17[0]) / (2 * (tree100_100_3_scal_enc_avg + tree100_100_3_scal_run_avg)), ecolor = 'black')
plt.bar(13, norm_tree100_100_3_vec_run, color = 'green', yerr = (int19[1] - int19[0]) / (2 * (tree100_100_3_scal_enc_avg + tree100_100_3_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree100_100_3_vec_enc)
...
plt.bar(14, norm_tree100_100_3_scal_enc, color = 'red', yerr = (int18[1] - int18[0]) / (2 * (tree100_100_3_scal_enc_avg + tree100_100_3_scal_run_avg)), ecolor = 'black')
plt.bar(14, norm_tree100_100_3_scal_run, color = 'yellow', yerr = (int20[1] - int20[0]) / (2 * (tree100_100_3_scal_enc_avg + tree100_100_3_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree100_100_3_scal_enc)
...
plt.bar(16, norm_tree100_100_6_vec_enc, color = 'blue', yerr = (int21[1] - int21[0]) / (2 * (tree100_100_6_scal_enc_avg + tree100_100_6_scal_run_avg)), ecolor = 'black')
plt.bar(16, norm_tree100_100_6_vec_run, color = 'green', yerr = (int23[1] - int23[0]) / (2 * (tree100_100_6_scal_enc_avg + tree100_100_6_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree100_100_6_vec_enc)
...
plt.bar(17, norm_tree100_100_6_scal_enc, color = 'red', yerr = (int22[1] - int22[0]) / (2 * (tree100_100_6_scal_enc_avg + tree100_100_6_scal_run_avg)), ecolor = 'black')
plt.bar(17, norm_tree100_100_6_scal_run, color = 'yellow', yerr = (int24[1] - int24[0]) / (2 * (tree100_100_6_scal_enc_avg + tree100_100_6_scal_run_avg)), ecolor = 'black', label = 'scalar', bottom = norm_tree100_100_6_scal_enc)
