...
plt.xticks([1,4,7,10,13,16],["sparse_3", "sparse_6", "dense_nonhomogeneous_3", "dense_nonhomogeneous_6", "dense_homogeneous_3", "dense_homogeneous_6"], rotation = 15, fontsize = 10)
plt.show()