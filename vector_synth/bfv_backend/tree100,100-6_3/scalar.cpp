...
{
    return {"186", "110", "956", "159", "227", "765", "485", "537", "624", "168", "321", "115", "75", "684", "564", "148", "106", "868", "38", "728", "766", "446", "834", "890", "98", "369", "732", "241", "622", "410", "64", "782", "309", "478", "591", "877", "548", "716", "743", "46", "992", "793", "127", "462", "270", "831", "902", "365", "822", "623", "883", "23", "865", "787", "885", "660", "976", "281", "466", "620", "517", "781"};
}
...
std::vector<ctxt> ScalarProgram::computation(std::map<std::string, ctxt> locs, RuntimeContext &info)
{
    ...
    info.eval->multiply(locs["865"], locs["168"], regs[15]);
    info.eval->relinearize_inplace(regs[15], rk);
    info.eval->multiply(locs["186"], locs["743"], regs[16]);
    ...
    info.eval->multiply(locs["890"], locs["766"], regs[18]);
    info.eval->relinearize_inplace(regs[18], rk);
    info.eval->multiply(locs["148"], locs["868"], regs[19]);
    ...
    info.eval->multiply(locs["660"], locs["548"], regs[22]);
    info.eval->relinearize_inplace(regs[22], rk);
    info.eval->multiply(locs["787"], locs["159"], regs[23]);
    ...
    info.eval->multiply(locs["537"], locs["446"], regs[25]);
    info.eval->relinearize_inplace(regs[25], rk);
    info.eval->multiply(locs["23"], locs["684"], regs[26]);
    ...
    info.eval->multiply(locs["98"], locs["241"], regs[31]);
    info.eval->relinearize_inplace(regs[31], rk);
    info.eval->multiply(locs["410"], locs["624"], regs[32]);
    ...
    info.eval->multiply(locs["831"], locs["620"], regs[34]);
    info.eval->relinearize_inplace(regs[34], rk);
    info.eval->multiply(locs["321"], locs["369"], regs[35]);
    ...
    info.eval->multiply(locs["46"], locs["227"], regs[38]);
    info.eval->relinearize_inplace(regs[38], rk);
    info.eval->multiply(locs["365"], locs["793"], regs[39]);
    ...
    info.eval->multiply(locs["110"], locs["877"], regs[41]);
    info.eval->relinearize_inplace(regs[41], rk);
    info.eval->multiply(locs["822"], locs["564"], regs[42]);
    ...
    info.eval->multiply(locs["732"], locs["591"], regs[46]);
    info.eval->relinearize_inplace(regs[46], rk);
    info.eval->multiply(locs["38"], locs["115"], regs[47]);
    ...
    info.eval->multiply(locs["622"], locs["75"], regs[49]);
    info.eval->relinearize_inplace(regs[49], rk);
    info.eval->multiply(locs["106"], locs["478"], regs[50]);
    ...
    info.eval->multiply(locs["976"], locs["623"], regs[53]);
    info.eval->relinearize_inplace(regs[53], rk);
    info.eval->multiply(locs["64"], locs["885"], regs[54]);
    ...
    info.eval->multiply(locs["883"], locs["728"], regs[56]);
    info.eval->relinearize_inplace(regs[56], rk);
    info.eval->multiply(locs["478"], locs["992"], regs[57]);
