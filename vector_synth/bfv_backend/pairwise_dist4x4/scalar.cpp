...
{
    return {"d:2", "a:0", "a:3", "b:2", "c:1", "d:0", "d:1", "c:0", "b:0", "c:2", "d:3", "b:1", "a:1", "c:3", "b:3", "a:2"};
}
...
std::vector<ctxt> ScalarProgram::computation(std::map<std::string, ctxt> locs, RuntimeContext &info)
{
    ...
    info.eval->sub(regs[98], regs[20], regs[114]);
    info.eval->sub(regs[98], regs[20], regs[115]);
    info.eval->multiply(regs[114], regs[115], regs[116]);
    info.eval->relinearize_inplace(regs[116], rk);
    info.eval->sub(regs[102], regs[24], regs[117]);
    info.eval->sub(regs[102], regs[24], regs[118]);
    info.eval->multiply(regs[117], regs[118], regs[119]);
    info.eval->relinearize_inplace(regs[119], rk);
    info.eval->add(regs[116], regs[119], regs[120]);
    info.eval->sub(regs[98], regs[29], regs[121]);
    info.eval->sub(regs[98], regs[29], regs[122]);
    info.eval->multiply(regs[121], regs[122], regs[123]);
    info.eval->relinearize_inplace(regs[123], rk);
    info.eval->sub(regs[102], regs[33], regs[124]);
    info.eval->sub(regs[102], regs[33], regs[125]);
