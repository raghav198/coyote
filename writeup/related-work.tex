...
It does not try to reduce the number of places where data shuffling is necessary, and cannot look ahead to determine the effects of specific placements on later rotations.
