...
Ramparts \cite{Ramparts} is a compiler that automatically lifts a program written in Julia into an optimized FHE circuit that perform the same computation.
