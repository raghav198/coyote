...
We discuss the specific performance tradeoffs of this choice. \raghav{Should I include those last two sentences or just save it for eval?} \milind{move this to eval.}
