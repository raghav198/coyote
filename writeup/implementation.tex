...
This schedule is then compiled into a simple vector IR by using a ready-list to schedule vector instructions according to a topological sort, inserting rotations as needed.
