...
This determines the data layout, as each input is placed on the same lane as its corresponding load gate. \milind{forward reference to 5.1 for how this can be overriden}
