...
\subsection{Data Layout}\label{sec:data-layout}\raghav{Is this a good place for this to go?}
...
This determines the data layout, as each input is placed on the same lane as its corresponding load gate. \raghav{Is this better?}
