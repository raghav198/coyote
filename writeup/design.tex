...
The contracted graph may not be acyclic, so we first mod out by all cycles before running the lane placement algorithm again.\milind{It's not clear what ``mod out by all cycles'' means -- add more meat here...}
