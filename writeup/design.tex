...
The layout for these inputs is then determined by the lanes chosen for their corresponding load gates. \milind{forward reference to 5.1 for how this can be overriden}