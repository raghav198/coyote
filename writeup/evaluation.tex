...
\begin{table}
    \small
    \caption{\system vectorization vs. expert-written code}
    \begin{tabular}{lcc}
        \toprule
...
\begin{table}
    \small
    \caption{Compilation time and vector operation counts for the data layout case study}\label{tab:bigass-data-layout}
    % \vspace{-1em}
    \begin{tabular}{lcccccccc}
    \toprule
