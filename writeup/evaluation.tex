...
The output layout of each $4\times 4$ block was provided as an input layout constraint (see Section~\ref{sec:using-coyote})
to another kernel, which took 64 of these blocks and performed the necessary reductions to arrange them into the final result of the $16\times 16$ matrix multiplication.
