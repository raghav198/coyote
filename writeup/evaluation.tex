...
Removing the timeout almost always causes the compilation time to increase, but doesn't significantly affect the speedup of the resulting schedule. \raghav{better way to say this?}
