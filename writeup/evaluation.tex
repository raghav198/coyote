...
The trees are generated according to three different regimes to cover different kinds of programs: \milind{Note the changed order.}
\begin{enumerate}
...
\milind{Surprising result to me: intuitively, we'd expect dense/hom to have the best speedup, followed by dens/nonhom, and then sparse. But that's not what we see. Why? Explain?}
...
\milind{Don't just launch into the figure description. Remind people why we're here :-)}
