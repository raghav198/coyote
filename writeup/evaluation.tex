...
\milind{Surprising result to me: intuitively, we'd expect dense/hom to have the best speedup, followed by dens/nonhom, and then sparse. But that's not what we see. Why? Explain?}\raghav{Is that sufficient?}
