...
\begin{figure}
    \includegraphics[width=0.6\linewidth]{figures/graphs/vector_speedups.png}
    \vspace{-1em}
...
\begin{figure}
    \includegraphics[width=0.6\linewidth]{figures/graphs/trees.png}
    \vspace{-2em}
...
\begin{figure}[t]
    \includegraphics[width=0.6\linewidth]{figures/graphs/case_study.png}
    \vspace{-1em}
