...
\begin{enumerate}
    ...
    \raghav{I don't like this wording but I'm not sure how to make it better}.
    Section~\ref{sec:codegen} describes the specifics of code generation.
\end{enumerate}
\raghav{TODO: maybe change the inline texttt stuff so it looks better?}
