...
We will use the circuit in Figure~\ref{fig:small-expr-circuit} that computes $(ab+c)(xy+z)$ as a running example. \raghav{TODO: swap this out for an updated example.}
