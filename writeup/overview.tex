...
\begin{enumerate}
    ...
    In the example in Figure~\ref{fig:quotient-circuit}, two edges have been contracted, identifying each multiplication vertex with one of its addition children.
