...
A programmer can use \system's DSL to specify a computation and generate an arithmetic circuit. \milind{move example here}
...
Alternatively, the programmer can choose to override this and manually provide a layout. \milind{maybe clarify that the layout choice is for inputs and outputs?} 
