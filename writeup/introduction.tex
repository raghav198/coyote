...
Using an approximate model of the relative latencies of each instruction \raghav{TODO: something with this??} (where multiplies and rotates have a latency of 1 and addition has a latency of 0.1), the total cost of this schedule is 3.2.
