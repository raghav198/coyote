...
\milind{High level idea of find subcircuits -> vectorize subcircuits -> do layout -> tweak subcircuits}
...
\system realizes our key insight by doing \milind{two sentences or so about simulated annealing...}
