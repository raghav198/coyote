...
std::vector<ctxt> VectorProgram::initialize_temps(RuntimeContext &info)
{
    ...
    ts[0] = encrypt_input("00000111111111111111111111100011111111111111111111100001111111111111111111111000111111111111111111111100", info);
    ts[1] = encrypt_input("00000111111111111111111111100011111111111111111111100001111111111111111111111000111111111111111111111100", info);
    ts[2] = encrypt_input("00000000000000111111111111111111111101111111111111111111111111111111111111111111101111111111111111111110", info);
    ts[3] = encrypt_input("00000000000000111111111111111111111101111111111111111111111111111111111111111111101111111111111111111110", info);
    return ts;
}
...
ctxt VectorProgram::computation(std::vector<ctxt> ts, std::map<std::string, ptxt> bits, RuntimeContext &info)
{
    ...
    info.eval->rotate_rows(vs[1], -17, gk, ss[7]); // __s7 = __v1 >> 17
    ...
    // __t5 = blend(__s9@00010000000000000000, __s6@00000101001000000000, __s8@00000000010010000000, __s7@00000000000000101000, __v1@00000000000000000001)
    ...
    info.eval->multiply_plain(ss[7], bits["00000000000000101000"], t5_4);
    ...
    // __t7 = blend(__s9@10000000000000000000, __s6@00000100100000000000, __s7@00000000000101100000, __s5@00000000000000010110, __v1@00000000000000000001)
    ...
    info.eval->multiply_plain(ss[7], bits["00000000000101100000"], t7_3);
    info.eval->multiply_plain(ss[5], bits["00000000000000010110"], t7_4);
    ...
    // __t11 = blend(__s9@10010000000000000000, __s6@00000001101000000000, __s8@00000000010010000000, __s7@00000000000101001000, __s5@00000000000000010110)
    ...
    info.eval->multiply_plain(ss[7], bits["00000000000101001000"], t11_4);
    info.eval->multiply_plain(ss[5], bits["00000000000000010110"], t11_5);
