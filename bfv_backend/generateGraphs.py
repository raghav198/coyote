...
print(float(dp3x3_scal_run_avg)/ dp3x3_vec_run_avg)
...
print(float(dp6x6_scal_run_avg)/ dp6x6_vec_run_avg)
...
print(float(mc4x4x2x2_scal_run_avg)/ mc4x4x2x2_vec_run_avg)
...
print(float(mc4x4x3x3_scal_run_avg)/ mc4x4x3x3_vec_run_avg)
...
print(float(mmd2x2_scal_run_avg)/ mmd2x2_vec_run_avg)
...
print(float(mmd3x3_scal_run_avg)/ mmd3x3_vec_run_avg)
...
print(float(mm2x2_scal_run_avg)/ mm2x2_vec_run_avg)
...
print(float(mm3x3_scal_run_avg)/ mm3x3_vec_run_avg)
...
print(float(pd2x2_scal_run_avg)/ pd2x2_vec_run_avg)
...
plt.bar(3, height = , color = 'green')

plt.bar(5, height = float(dp6x6_vec_encrun_avg)/dp6x6_scal_encrun_avg, color = 'blue', yerr = (int5[1] - int5[0]) / (2 * dp6x6_scal_encrun_avg), ecolor = 'black')
plt.bar(6, height = 1, color = 'red', yerr = (int6[1] - int6[0]) / (2 * dp6x6_scal_encrun_avg), ecolor = 'black')
plt.bar(7, height = , color = 'green')

plt.bar(9, height = float(mc4x4x2x2_vec_encrun_avg)/mc4x4x2x2_scal_encrun_avg, color = 'blue', yerr = (int9[1] - int9[0]) / (2 * mc4x4x2x2_scal_encrun_avg), ecolor = 'black')
plt.bar(10, height = 1, color = 'red', yerr = (int10[1] - int10[0]) / (2 * mc4x4x2x2_scal_encrun_avg), ecolor = 'black')
plt.bar(11, height = , color = 'green')

plt.bar(13, height = float(mc4x4x3x3_vec_encrun_avg)/mc4x4x3x3_scal_encrun_avg, color = 'blue', yerr = (int13[1] - int13[0]) / (2 * mc4x4x3x3_scal_encrun_avg), ecolor = 'black')
plt.bar(14, height = 1, color = 'red', yerr = (int14[1] - int14[0]) / (2 * mc4x4x3x3_scal_encrun_avg), ecolor = 'black')
plt.bar(15, height = , color = 'green')

plt.bar(17, height = float(mmd2x2_vec_encrun_avg)/mmd2x2_scal_encrun_avg, color = 'blue', yerr = (int17[1] - int17[0]) / (2 * mmd2x2_scal_encrun_avg), ecolor = 'black')
plt.bar(18, height = 1, color = 'red', yerr = (int18[1] - int18[0]) / (2 * mmd2x2_scal_encrun_avg), ecolor = 'black')
plt.bar(19, height = , color = 'green')

plt.bar(21, height = float(mmd3x3_vec_encrun_avg)/mmd3x3_scal_encrun_avg, color = 'blue', yerr = (int21[1] - int21[0]) / (2 * mmd3x3_scal_encrun_avg), ecolor = 'black')
plt.bar(22, height = 1, color = 'red', yerr = (int22[1] - int22[0]) / (2 * mmd3x3_scal_encrun_avg), ecolor = 'black')
plt.bar(23, height = , color = 'green')

plt.bar(25, height = float(mm2x2_vec_encrun_avg)/mm2x2_scal_encrun_avg, color = 'blue', yerr = (int25[1] - int25[0]) / (2 * mm2x2_scal_encrun_avg), ecolor = 'black')
plt.bar(26, height = 1, color = 'red', yerr = (int26[1] - int26[0]) / (2 * mm2x2_scal_encrun_avg), ecolor = 'black')
plt.bar(27, height = , color = 'green')

plt.bar(29, height = float(mm3x3_vec_encrun_avg)/mm3x3_scal_encrun_avg, color = 'blue', yerr = (int29[1] - int29[0]) / (2 * mm3x3_scal_encrun_avg), ecolor = 'black')
plt.bar(30, height = 1, color = 'red', yerr = (int30[1] - int30[0]) / (2 * mm3x3_scal_encrun_avg), ecolor = 'black')
plt.bar(31, height = , color = 'green')

plt.bar(33, height = float(pd2x2_vec_encrun_avg)/pd2x2_scal_encrun_avg, color = 'blue', yerr = (int33[1] - int33[0]) / (2 * pd2x2_scal_encrun_avg), ecolor = 'black')
plt.bar(34, height = 1, color = 'red', yerr = (int34[1] - int34[0]) / (2 * pd2x2_scal_encrun_avg), ecolor = 'black')
plt.bar(35, height = , color = 'green')

plt.bar(37, height = float(pd3x3_vec_encrun_avg)/pd3x3_scal_encrun_avg, color = 'blue', yerr = (int37[1] - int37[0]) / (2 * pd3x3_scal_encrun_avg), ecolor = 'black')
plt.bar(38, height = 1, color = 'red', yerr = (int38[1] - int38[0]) / (2 * pd3x3_scal_encrun_avg), ecolor = 'black')
plt.bar(39, height = , color = 'green')
