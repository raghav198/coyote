...
{
    return {"distances_3x3_partially(ys):2", "distances_3x3_partially(ys):0", "distances_3x3_partially(xs):2", "distances_3x3_partially(ys):1", "distances_3x3_partially(xs):0", "distances_3x3_partially(xs):1"};
}
