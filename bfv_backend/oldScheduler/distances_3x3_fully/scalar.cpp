...
{
    return {"distances_3x3_fully(ys):2", "distances_3x3_fully(ys):1", "distances_3x3_fully(xs):1", "distances_3x3_fully(xs):2", "distances_3x3_fully(ys):0", "distances_3x3_fully(xs):0"};
}
