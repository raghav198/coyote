...
{
    return {"conv_4x2_partially(sig):2", "conv_4x2_partially(sig):1", "conv_4x2_partially(ker):1", "conv_4x2_partially(sig):0", "conv_4x2_partially(sig):3", "conv_4x2_partially(ker):0"};
}
