...
{
    return {"788", "284", "834", "573", "198", "228", "665", "452", "873", "711", "450", "103", "576", "116", "437", "88", "494", "781", "742", "67", "501", "762", "290", "340", "922", "445", "890", "940", "811", "694", "640", "577", "825", "222", "733", "751", "385", "619", "386", "1015", "692", "69", "1019", "817", "657", "896", "519", "178", "539", "971", "194", "985", "252", "995", "794", "546", "95", "1008", "471", "390", "45"};
}
...
std::vector<ctxt> ScalarProgram::computation(std::map<std::string, ctxt> locs, RuntimeContext &info)
{
    ...
    info.eval->multiply(locs["711"], locs["228"], regs[0]);
    info.eval->relinearize_inplace(regs[0], rk);
    info.eval->multiply(locs["657"], locs["781"], regs[1]);
    info.eval->relinearize_inplace(regs[1], rk);
    info.eval->multiply(regs[0], regs[1], regs[2]);
    info.eval->relinearize_inplace(regs[2], rk);
    info.eval->multiply(locs["103"], locs["194"], regs[3]);
    info.eval->relinearize_inplace(regs[3], rk);
    info.eval->multiply(locs["1008"], locs["971"], regs[4]);
    ...
    info.eval->multiply(locs["971"], locs["694"], regs[10]);
    info.eval->relinearize_inplace(regs[10], rk);
    info.eval->multiply(locs["437"], locs["873"], regs[11]);
    ...
    info.eval->multiply(locs["519"], locs["45"], regs[16]);
    ...
    info.eval->multiply(locs["445"], locs["576"], regs[19]);
    ...
    info.eval->multiply(locs["890"], locs["940"], regs[22]);
    ...
    info.eval->multiply(locs["573"], locs["69"], regs[25]);
    ...
    info.eval->multiply(locs["67"], locs["817"], regs[32]);
    ...
    info.eval->multiply(locs["577"], locs["385"], regs[42]);
    ...
    info.eval->multiply(locs["450"], locs["890"], regs[50]);
    ...
    info.eval->multiply(locs["88"], locs["788"], regs[53]);
    info.eval->relinearize_inplace(regs[53], rk);
    info.eval->multiply(locs["494"], locs["762"], regs[54]);
    ...
    info.eval->multiply(locs["539"], locs["665"], regs[56]);
