...
{
    return {"matmul_3x3_un(b):1;1", "matmul_3x3_un(a):1;0", "matmul_3x3_un(b):0;1", "matmul_3x3_un(a):1;1", "matmul_3x3_un(b):0;2", "matmul_3x3_un(b):2;0", "matmul_3x3_un(b):2;1", "matmul_3x3_un(a):0;2", "matmul_3x3_un(b):1;2", "matmul_3x3_un(a):0;0", "matmul_3x3_un(a):2;0", "matmul_3x3_un(a):1;2", "matmul_3x3_un(a):0;1", "matmul_3x3_un(b):2;2", "matmul_3x3_un(b):1;0", "matmul_3x3_un(a):2;2", "matmul_3x3_un(a):2;1", "matmul_3x3_un(b):0;0"};
}
