...
{
    return {"matmul_2x2_partially(b):1;0", "matmul_2x2_partially(a):0;1", "matmul_2x2_partially(a):1;0", "matmul_2x2_partially(a):1;1", "matmul_2x2_partially(b):0;1", "matmul_2x2_partially(a):0;0", "matmul_2x2_partially(b):1;1", "matmul_2x2_partially(b):0;0"};
}
