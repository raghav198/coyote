...
{
    return {"matmul_3x3_case4(a_2):1", "matmul_3x3_case4(a_0):0", "matmul_3x3_case4(a_0):1", "matmul_3x3_case4(a_1):2", "matmul_3x3_case4(b_1):0", "matmul_3x3_case4(a_1):0", "matmul_3x3_case4(b_0):2", "matmul_3x3_case4(a_2):2", "matmul_3x3_case4(a_2):0", "matmul_3x3_case4(b_1):2", "matmul_3x3_case4(b_2):2", "matmul_3x3_case4(b_2):1", "matmul_3x3_case4(b_1):1", "matmul_3x3_case4(a_0):2", "matmul_3x3_case4(b_0):0", "matmul_3x3_case4(a_1):1", "matmul_3x3_case4(b_2):0", "matmul_3x3_case4(b_0):1"};
}
...
std::vector<ctxt> ScalarProgram::computation(std::map<std::string, ctxt> locs, RuntimeContext &info)
{
    ...
    regs[0] = locs["matmul_3x3_case4(a_0):0"];
    regs[1] = locs["matmul_3x3_case4(b_0):0"];
    info.eval->multiply(regs[0], regs[1], regs[2]);
    info.eval->relinearize_inplace(regs[2], rk);
    regs[3] = locs["matmul_3x3_case4(a_1):0"];
    regs[4] = locs["matmul_3x3_case4(b_1):0"];
    info.eval->multiply(regs[3], regs[4], regs[5]);
    info.eval->relinearize_inplace(regs[5], rk);
    regs[6] = locs["matmul_3x3_case4(a_2):0"];
    regs[7] = locs["matmul_3x3_case4(b_2):0"];
    info.eval->multiply(regs[6], regs[7], regs[8]);
    info.eval->relinearize_inplace(regs[8], rk);
    info.eval->add(regs[5], regs[8], regs[9]);
    info.eval->add(regs[2], regs[9], regs[10]);
    regs[11] = locs["matmul_3x3_case4(b_0):1"];
    info.eval->multiply(regs[0], regs[11], regs[12]);
    info.eval->relinearize_inplace(regs[12], rk);
    regs[13] = locs["matmul_3x3_case4(b_1):1"];
    info.eval->multiply(regs[3], regs[13], regs[14]);
    info.eval->relinearize_inplace(regs[14], rk);
    regs[15] = locs["matmul_3x3_case4(b_2):1"];
