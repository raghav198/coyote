...
{
    return {"matmul_2x2_un(b):1;0", "matmul_2x2_un(a):0;0", "matmul_2x2_un(a):1;0", "matmul_2x2_un(b):0;0", "matmul_2x2_un(b):0;1", "matmul_2x2_un(b):1;1", "matmul_2x2_un(a):1;1", "matmul_2x2_un(a):0;1"};
}
