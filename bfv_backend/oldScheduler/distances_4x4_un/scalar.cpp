...
{
    return {"distances_4x4_un(ys):0", "distances_4x4_un(xs):3", "distances_4x4_un(xs):0", "distances_4x4_un(xs):1", "distances_4x4_un(ys):2", "distances_4x4_un(ys):1", "distances_4x4_un(xs):2", "distances_4x4_un(ys):3"};
}
...
std::vector<ctxt> ScalarProgram::computation(std::map<std::string, ctxt> locs, RuntimeContext &info)
{
    ...
    regs[13] = locs["distances_4x4_un(ys):3"];
    ...
    regs[17] = locs["distances_4x4_un(xs):1"];
    ...
    regs[30] = locs["distances_4x4_un(xs):2"];
    ...
    regs[43] = locs["distances_4x4_un(xs):3"];
