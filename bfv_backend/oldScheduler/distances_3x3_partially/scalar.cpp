...
{
    return {"distances_3x3_partially(xs):1", "distances_3x3_partially(ys):2", "distances_3x3_partially(xs):0", "distances_3x3_partially(ys):0", "distances_3x3_partially(ys):1", "distances_3x3_partially(xs):2"};
}
...
std::vector<ctxt> ScalarProgram::computation(std::map<std::string, ctxt> locs, RuntimeContext &info)
{
    ...
    regs[13] = locs["distances_3x3_partially(xs):1"];
    ...
    regs[23] = locs["distances_3x3_partially(xs):2"];
