...
{
    return {"decision_tree_packed_fully(os):2", "decision_tree_packed_fully(cs):0", "decision_tree_packed_fully(cs):1", "decision_tree_packed_fully(os):3", "1", "decision_tree_packed_fully(os):0", "decision_tree_packed_fully(os):1", "decision_tree_packed_fully(os):4", "decision_tree_packed_fully(os):5", "decision_tree_packed_fully(cs):2"};
}
