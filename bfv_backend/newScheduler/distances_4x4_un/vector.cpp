...
std::vector<ctxt> VectorProgram::initialize_temps(RuntimeContext &info)
{
    ...
    ts[0] = encrypt_input("1111111111111111111111000111111111111111111111100000011111111111111111111100001111111111111111111111000000", info);
    ts[1] = encrypt_input("1111111111111111111111000111111111111111111111100000011111111111111111111100001111111111111111111111000000", info);
    ts[2] = encrypt_input("0000000000000001111111111111111111111001111111111111111111111011111111111111111111101111111111111111111111", info);
    ts[3] = encrypt_input("0000000000000001111111111111111111111001111111111111111111111011111111111111111111101111111111111111111111", info);
    return ts;
}
