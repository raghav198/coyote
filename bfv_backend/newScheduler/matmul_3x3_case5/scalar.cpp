...
{
    return {"matmul_3x3_case5(a_02):0", "matmul_3x3_case5(b_11):0", "matmul_3x3_case5(b_10):0", "matmul_3x3_case5(a_11):0", "matmul_3x3_case5(b_00):0", "matmul_3x3_case5(b_20):0", "matmul_3x3_case5(a_21):0", "matmul_3x3_case5(b_01):0", "matmul_3x3_case5(a_10):0", "matmul_3x3_case5(a_12):0", "matmul_3x3_case5(a_20):0", "matmul_3x3_case5(b_22):0", "matmul_3x3_case5(b_21):0", "matmul_3x3_case5(a_22):0", "matmul_3x3_case5(b_12):0", "matmul_3x3_case5(b_02):0", "matmul_3x3_case5(a_01):0", "matmul_3x3_case5(a_00):0"};
}
...
std::vector<ctxt> ScalarProgram::computation(std::map<std::string, ctxt> locs, RuntimeContext &info)
{
    ...
    regs[0] = locs["matmul_3x3_case5(a_00):0"];
    regs[1] = locs["matmul_3x3_case5(b_00):0"];
    info.eval->multiply(regs[0], regs[1], regs[2]);
    info.eval->relinearize_inplace(regs[2], rk);
    regs[3] = locs["matmul_3x3_case5(a_01):0"];
    regs[4] = locs["matmul_3x3_case5(b_10):0"];
    info.eval->multiply(regs[3], regs[4], regs[5]);
    info.eval->relinearize_inplace(regs[5], rk);
    regs[6] = locs["matmul_3x3_case5(a_02):0"];
    regs[7] = locs["matmul_3x3_case5(b_20):0"];
    info.eval->multiply(regs[6], regs[7], regs[8]);
    info.eval->relinearize_inplace(regs[8], rk);
    info.eval->add(regs[5], regs[8], regs[9]);
    info.eval->add(regs[2], regs[9], regs[10]);
    regs[11] = locs["matmul_3x3_case5(b_01):0"];
    info.eval->multiply(regs[0], regs[11], regs[12]);
    info.eval->relinearize_inplace(regs[12], rk);
    regs[13] = locs["matmul_3x3_case5(b_11):0"];
    info.eval->multiply(regs[3], regs[13], regs[14]);
    info.eval->relinearize_inplace(regs[14], rk);
    regs[15] = locs["matmul_3x3_case5(b_21):0"];
