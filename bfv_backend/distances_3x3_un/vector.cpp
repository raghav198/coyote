...
std::vector<ctxt> VectorProgram::initialize_temps(RuntimeContext &info)
{
    ...
    ts[0] = encrypt_input("00111111111111111111111100111111111111111111111100111111111111111111111000", info);
    ts[1] = encrypt_input("00111111111111111111111100111111111111111111111100111111111111111111111000", info);
    ts[2] = encrypt_input("00000011111111111111111111110111111111111111111111001111111111111111111111", info);
    ts[3] = encrypt_input("00000011111111111111111111110111111111111111111111001111111111111111111111", info);
    return ts;
}
