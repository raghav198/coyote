...
std::vector<ctxt> VectorProgram::initialize_temps(RuntimeContext &info)
{
    ...
    ts[0] = encrypt_input("11111111111111111111101111111111111111111111111111111111111111111100000000", info);
    ts[1] = encrypt_input("11111111111111111111101111111111111111111111111111111111111111111100000000", info);
    ts[2] = encrypt_input("01111111111111111111110000111111111111111111111100011111111111111111111110", info);
    ts[3] = encrypt_input("01111111111111111111110000111111111111111111111100011111111111111111111110", info);
    return ts;
}
