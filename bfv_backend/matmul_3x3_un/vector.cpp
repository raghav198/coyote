...
ctxt VectorProgram::computation(std::vector<ctxt> ts, std::map<std::string, ptxt> bits, RuntimeContext &info)
{
    ...
    // __t5 = blend(__s9@11000000000, __s5@00101000000, __s8@00010100000, __s7@00000001000)
    ctxt t5_1, t5_2, t5_3, t5_4;
    info.eval->multiply_plain(ss[9], bits["11000000000"], t5_1);
    info.eval->multiply_plain(ss[5], bits["00101000000"], t5_2);
    info.eval->multiply_plain(ss[8], bits["00010100000"], t5_3);
    info.eval->multiply_plain(ss[7], bits["00000001000"], t5_4);
    ...
    // __t7 = blend(__s8@10101000000, __s5@01000100000, __s7@00010000000, __s6@00000001000)
    ctxt t7_1, t7_2, t7_3, t7_4;
    info.eval->multiply_plain(ss[8], bits["10101000000"], t7_1);
    info.eval->multiply_plain(ss[5], bits["01000100000"], t7_2);
    info.eval->multiply_plain(ss[7], bits["00010000000"], t7_3);
    ...
    // __t9 = blend(__s5@10010001100, __s8@01000000000, __s9@00100000000, __s7@00001100000, __s6@00000010000)
    ctxt t9_1, t9_2, t9_3, t9_4, t9_5;
    info.eval->multiply_plain(ss[5], bits["10010001100"], t9_1);
    info.eval->multiply_plain(ss[8], bits["01000000000"], t9_2);
    info.eval->multiply_plain(ss[9], bits["00100000000"], t9_3);
    info.eval->multiply_plain(ss[7], bits["00001100000"], t9_4);
    ...
    info.eval->multiply(ss[3], ss[5], vs[7]); // __v7 = __s3 * __s5
    ...
    info.eval->multiply(ts[13], ss[7], vs[8]); // __v8 = __t13 * __s7
