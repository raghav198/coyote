...
{
    return {"distances_4x4_partially(xs):3", "distances_4x4_partially(ys):0", "distances_4x4_partially(ys):2", "distances_4x4_partially(xs):0", "distances_4x4_partially(xs):1", "distances_4x4_partially(xs):2", "distances_4x4_partially(ys):3", "distances_4x4_partially(ys):1"};
}
