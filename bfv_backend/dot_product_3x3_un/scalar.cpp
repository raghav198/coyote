...
{
    return {"dot_product_3x3_un(v2):2", "dot_product_3x3_un(v1):0", "dot_product_3x3_un(v1):2", "dot_product_3x3_un(v2):0", "dot_product_3x3_un(v1):1", "dot_product_3x3_un(v2):1"};
}
