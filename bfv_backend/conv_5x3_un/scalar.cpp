...
{
    return {"conv_5x3_un(ker):0", "conv_5x3_un(sig):1", "conv_5x3_un(ker):1", "conv_5x3_un(ker):2", "conv_5x3_un(sig):0", "conv_5x3_un(sig):3", "conv_5x3_un(sig):4", "conv_5x3_un(sig):2"};
}
