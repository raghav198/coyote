...
{
    return {"distances_5x5_partially(ys):3", "distances_5x5_partially(xs):3", "distances_5x5_partially(ys):0", "distances_5x5_partially(xs):4", "distances_5x5_partially(ys):1", "distances_5x5_partially(xs):2", "distances_5x5_partially(xs):1", "distances_5x5_partially(ys):2", "distances_5x5_partially(xs):0", "distances_5x5_partially(ys):4"};
}
