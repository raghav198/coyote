...
{
    return {"conv_5x3_fully(sig):1", "conv_5x3_fully(sig):3", "conv_5x3_fully(ker):1", "conv_5x3_fully(sig):2", "conv_5x3_fully(ker):2", "conv_5x3_fully(ker):0", "conv_5x3_fully(sig):4", "conv_5x3_fully(sig):0"};
}
